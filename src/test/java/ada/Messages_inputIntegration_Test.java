...
//  private static final String SHORT_MESSAGE = "Short and Long COEXIST";
  private static final String LONG_MESSAGE = "Psych a short message";
  //          ""
  //                  +
  ...
  private NetworkSocketClient client1;
  private NetworkSocketClient client2;

  @Before
  public void setUp() throws IOException {
    host = new TCPHost(PORT);
    client1 = new NetworkSocketClient("localhost", PORT);
    client2 = new NetworkSocketClient("localhost", PORT);
    sender1 = new NetworkSender(client1);
    reader2 = new NetworkReader(client2);
  }

  @Test
  public void sendMessage_succeeds() {
    Thread hostThread =
        new Thread(
            () -> {
